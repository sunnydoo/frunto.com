...
if (isAppLoggedIn()){
	...
	if ($action=='login') {
      ...
      if (isset($_POST['autologin']))
		...
		// New account
		if ( !$ulogin->CreateUserWithProj( $_POST['user'],  $_POST['pwd'], $_POST['project'])  )
...
if (isAppLoggedIn()){
	?>
		...
		<form action="admin.php" method="POST"><input type="hidden" name="action" value="refresh"><input type="submit" value="Refresh page"></form>
		<form action="admin.php" method="POST"><input type="hidden" name="action" value="logout"><input type="submit" value="Logout"></form>
		<form action="admin.php" method="POST"><input type="hidden" name="action" value="delete"><input type="submit" value="Delete account"></form>
	<?php
} else {
?>
	<?php echo ($msg);?>
